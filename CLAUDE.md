...
- **포트폴리오 1차 완료(2026-08-04)**: 고객 상품 상세·내 주문·상태 타임라인,
  OMS 백오더 수량 분해·주문상품 표시·선택 일괄 출고, WMS 원장·부분입고·발주 취소·폼 로그인·역할 인가,
  375px부터 데스크톱까지의 OMS 반응형 UI를 구현했다. `docs/manual-verification-scenarios.md`의 로컬 통합 수동 검증도 완료했다.
